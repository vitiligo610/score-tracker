...
export default function AddTeamPlayer({ teamId, existingPlayerIds }: AddTeamPlayerProps) {
            ...
            {loading ? (
              ...
              <div className="space-y-2">
                {filteredPlayers.map((player) => {
                  ...
                  const isInOtherTeam = player.team_id !== null && player.team_id !== teamId;
