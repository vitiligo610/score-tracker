...
import { CareerStats } from "@/lib/definitons";
      ...
      <Card>
        ...
        <CardContent>
          <dl className="grid grid-cols-2 gap-4">
            ...
            <StatItem label="Strike Rate" value={stats.batting.strike_rate.toFixed(2)} />
            <StatItem label="Highest Score" value={stats.batting.highest_score} />
      ...
      <Card>
        ...
        <CardContent>
          <dl className="grid grid-cols-2 gap-4">
            ...
            <StatItem label="Strike Rate" value={stats.bowling.strike_rate.toFixed(2)} />
